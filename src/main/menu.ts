      ...
      submenu: [
        {
          ...
          click: () => this.sendToRenderer('menu:openFolder'),
        },
      ],
    };
    ...
    const sidebarViewItems: MenuItemConstructorOptions[] = [
      {
        ...
        click: () => this.sendToRenderer('menu:toggleLeftSidebar'),
      },
      {
        label: 'Toggle Agent Side Bar',
        accelerator: 'Command+Shift+B',
        click: () => this.sendToRenderer('menu:toggleRightSidebar'),
      },
      { type: 'separator' },
    ];
      ...
      submenu: [
        {
          label: 'Learn More',
          click() {
            shell.openExternal('https://github.com/MarisaMagic/LR-Agent');
          },
        },
        {
          label: 'Documentation',
